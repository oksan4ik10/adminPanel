...
function getPageList() {
  $("h1").remove(); //подключение к серверу
...
getPageList(); //обработчик по нажатию на кнопку
